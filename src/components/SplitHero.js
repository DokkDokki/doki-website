...
export default function SplitHero() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      ========================================= */}
      <motion.div
        className="relative flex-1 flex items-center justify-center cursor-pointer border-b md:border-b-0 md:border-r border-white/5 overflow-hidden min-h-[50vh] md:min-h-0"
      ...
      >
        ...
        <motion.div 
          ...
          transition={transitionConfig}
        >
          <div className="text-2xl md:text-5xl font-light text-slate-500 mb-2 tracking-widest">
            Hi, I'm
          </div>
          <h1 className="text-6xl md:text-9xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-teal-200 drop-shadow-[0_0_30px_rgba(45,212,191,0.3)]">
            Doki.
          </h1>
      ...
      ========================================= */}
      <motion.div
        className="relative flex-1 flex items-center justify-center cursor-pointer overflow-hidden min-h-[50vh] md:min-h-0"
      ...
      >
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-light tracking-normal text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-fuchsia-500 drop-shadow-[0_0_30px_rgba(217,70,239,0.4)] text-center">
            DOKIMACHINE
          </h1>
          ...
          <motion.div 
             ...
             className="text-center mt-4 md:mt-6"
          >
             <p className="text-fuchsia-200/70 text-[10px] md:text-lg uppercase tracking-[0.4em] font-medium">MUSIC /// DJ</p>
             <Link href="/dokimachine">
               <button className="mt-6 md:mt-8 px-6 md:px-8 py-2 md:py-3 border-2 border-fuchsia-500/50 bg-black/50 backdrop-blur-md text-white rounded-full hover:bg-fuchsia-500/20 transition-all font-bold tracking-widest text-xs md:text-base">
                 Enter The Machine
               </button>
             </Link>
          </motion.div>
